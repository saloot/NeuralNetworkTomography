...
ax = axs[0]
ax.bar(T_range_neuinf,gap_exc_void_glm,bar_width,color='b',label='GLM');
...
ax = axs[1]
ax.bar(T_range_neuinf,gap_void_inh_glm,bar_width,color='white',edgecolor='blue',hatch="//",label='GLM');
ax.bar(T_range_neuinf + 2*bar_width,gap_exc_void_neuinf,bar_width,color='white',edgecolor='orange',hatch="//",label='NeuInf');
ax.bar(T_range_neuinf + bar_width,gap_void_inh_cc,bar_width,color='white',edgecolor='red',hatch="//",label='Cross Correlogram');
