...
ihbasprs.hpeaks = [.1 10];  % Peak location for first and last vectors

%------Changes here-------
%ihbasprs.hpeaks = [.1 0.5];
%-------------------------
...
ih = ihbasis*[-10 -7.5 -5 -2.5 0 1 2 1 -1 -2]';  % h current
