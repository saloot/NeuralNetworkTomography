...
if (inference_method == 7):
    ...
    file_name_spikes = '/scracth/salavati/NeuralNetworkTomography/Network\ Tomography\ Toolbox/Data/Spikes/Moritz_Spike_Times.txt'
    file_name_prefix = 'Moritz'
elif (inference_method == 5):
    inference_method = 7
    file_name_spikes = '../Data/Spikes/HC3_ec013_198_processed.txt'
    file_name_spikes = '/scracth/salavati/NeuralNetworkTomography/Network\ Tomography\ Toolbox/Data/Spikes/HC3_ec013_198_processed.txt'
