...
for TT in 400000 5000000 6000000 7000000; do
    for ff in 50 100 150 200; do
        ...
        python Transform_to_Ternary.py -B 4 -o "0,1" -N 1000 -${plot_var} ${ff} -F "../Data/Graphs/LIF_Actual_Connectivity.txt" -A "W_Pll_${file_ending}_${ff}_T_${TT}"

        # Calculating accuracy
        python Calculate_Accuracy.py -B 4 -o "0,1" -N 1000 -${plot_var} ${ff} -n 0 -F "../Data/Graphs/LIF_Actual_Connectivity.txt" -A "W_Binary_W_Pll_${file_ending}_${ff}_T_${TT}"
    done   
done

# Plot precision as a function of number of recorded samples
python Plot_Results.py -o "0,1" -N 1000 -n 0 -f 50 -F "../Data/Graphs/LIF_Actual_Connectivity.txt" -A "W_Binary_W_Pll_${file_ending}_${ff}_" -U "P" -O "4000000,5000000,6000000,7000000"